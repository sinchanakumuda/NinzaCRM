...
public class CreateCampaignWithStatus {
	...
	PropertiesFileUtility plib = new PropertiesFileUtility(); 
	  ...
	  String campname = elib.toReadDataFromExcelFile("Campaign", 4, 2); 
	  String size = elib.toReadDataFromExcelFile("Campaign", 4, 3); 
	  String status = elib.toReadDataFromExcelFile("Campaign", 4, 4); 
	  String campNameRandom=campname+jlib.togetRandomAlpha();
	  
	  System.out.println(campname);
	  System.out.println(size);
	  System.out.println(status);
	  System.out.println(campNameRandom);
	  ...
	  cp.getCampaignNameTF().sendKeys(campNameRandom); 
	  ...
	  if (msg.contains(campNameRandom)) { 
