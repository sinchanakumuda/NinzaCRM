...
public class CreateCampaignForAssertionTest extends BaseClass
{
	...
	public void createCampaignWithMandatoryFieldTest() throws Throwable
	{
		...
		String TARGET_SIZE = elib.toReadDataFromExcelFile("Campaign",1,3); 
				  ...
				  Reporter.log("Reporter log "+campNameWithRandom);
				  System.out.println("SOP "+campNameWithRandom);
				  ...
				  Reporter.log("Toast web element msg "+toastmsg);
				  System.out.println("SOP Toast web element msg "+toastmsg);
				  wlib.waitForVisibilityOfElement(driver, toastmsg); 
				  String msg = toastmsg.getText();
				  Reporter.log("msg "+msg);
				  System.out.println("SOP msg in website "+msg);
				  ...
				  Assert.assertEquals(msg,"Campaign "+campNameWithRandom+" Successfully Added" );
				  System.out.println("createCampaignWithMandatoryFieldTest After Hard Assertion"); 
	...
	public void createCampaignWithStatusTest() throws Throwable
	{
				 ...
				 /* if (msg.contains(campNameWithRandom)) { 
				  ...
				  Assert.assertTrue(msg.contains(campNameWithRandom));
	}
